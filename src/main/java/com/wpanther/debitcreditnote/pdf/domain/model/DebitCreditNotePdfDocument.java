...
/**
 * Aggregate Root representing a Debit/Credit Note PDF document
 *
 * This aggregate encapsulates the PDF generation lifecycle including
 * generation and XML embedding for debit/credit notes.
 */
public class DebitCreditNotePdfDocument {
    ...
    public static class Builder {
        ...
        public DebitCreditNotePdfDocument build() {
            return new DebitCreditNotePdfDocument(this);
        }
    }
