...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/rsm:DebitCreditNote_CrossIndustryInvoice">
        ...
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="debitcreditnote-page"
            ...
            <fo:page-sequence master-reference="debitcreditnote-page">
                <!-- Header -->
                                ...
                                <fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        <fo:block text-align="right">
                                            e-Tax Debit/Credit Note / ใบเพิ่มหนี้/ใบลดหนี้อิเล็กทรอนิกส์
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block font-family="{$font-family}" font-size="{$font-size-title}"
                        ...
                        <xsl:value-of select="$doc/ram:Name"/>
                    </fo:block>
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell padding="2mm" border="0.5pt solid #dddddd" background-color="#e8e8e8">
                                    ...
                                    <fo:block font-size="{$font-size-small}">Document No.</fo:block>
                                </fo:table-cell>
                        ...
                        <fo:table-body>
                            ...
                            <xsl:if test="$summation/ram:OriginalInformationAmount">
                                <fo:table-row>
                                    <fo:table-cell><fo:block/></fo:table-cell>
                                    <fo:table-cell padding="2mm" border="0.5pt solid #dddddd" background-color="#f5f5f5">
                                        <fo:block text-align="right">ยอดเงินตามเอกสารเดิม</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell padding="2mm" border="0.5pt solid #dddddd">
                                        <fo:block text-align="right">
                            ...
                            <xsl:if test="$summation/ram:DifferenceInformationAmount">
                                <fo:table-row>
                                    <fo:table-cell><fo:block/></fo:table-cell>
                                    <fo:table-cell padding="2mm" border="0.5pt solid #dddddd" background-color="#f5f5f5">
                                        <fo:block text-align="right">ผลต่าง (Difference)</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell padding="2mm" border="0.5pt solid #dddddd">
                                        <fo:block text-align="right">
